<div class="row" id="panelsrow">
    <div class="col-lg-12" id="WelcomeToWeb">
        ...
        <div id="morecontent"  class="panel-default">
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><i class="fa fa-fw fa-gift"></i> Bring your vision to life</h4>
            </div>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><i class="fa fa-fw fa-compass "></i> Displaying the Big Picture</h4>
            </div>
            <div class="panel-body">
                <section class="itemdata">
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><i class="fa fa-fw  fa-check"></i> The Order of Things</h4>
            </div>
            <div class="panel-body">
                <section class="itemdata">

                    Starting from user story we are caring project all the way to deployment and if hardware involved to implementation.
                    Planning a project and providing documentation step by step our main goal is to achieve customer satisfaction.
                    You want to run software on a single computer, network, your existing website or on a cloud we incorporate security, scalability and integrity based on defined today WWW standards
